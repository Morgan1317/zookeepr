...
const handleAnimalFormSubmit = event => {
  ...
  // bc req is from server don't need to provide full URL
  // now we need to fetch and POST our data that needs to be sent to the backend from the front
  //headers property informs request that this is going to be JSON data
        // without these we would never rec req.body on the server
  fetch('/api/animals', {
    method: 'POST',
    headers: {
